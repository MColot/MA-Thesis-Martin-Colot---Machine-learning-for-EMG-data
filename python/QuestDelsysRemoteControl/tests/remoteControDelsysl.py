...
def emgDataCollection():
    ...
    """
    global host, EmgIsRecording, EMG_CHANNEL_COUNT, waitingForDelsysThread
...
def recordQuest():
    ...
    """
    global currentRecording, waitingForDelsysThread, questIsRecording, triggerTimestamp
    triggerTimestamps = []
...
def recordDelsys():
    ...
    """
    global waitingForDelsysThread, EmgIsRecording
...
def stopRecording():
    ...
    """
    global currentRecording, EmgIsRecording, questIsRecording, triggerTimestamp
...
def trigger():
    ...
    """
    global EmgIsRecording, triggerTimestamp
    if delsysIsRecording:
        pass
